...
// - zmienia tylko język strony (UI), nie treść pisma
// - działa offline w Acode
...
const I18N = {
  pl: {
    ...
    f2a: "Nie zapisujemy Twoich pism na stronie landing. W aplikacji działamy zgodnie z zasadą minimalnych danych.",
...
function applyI18n(lang){
  ...
  localStorage.setItem("sb_ui_lang", lang);
...
function initI18n(){
  const saved = localStorage.getItem("sb_ui_lang");
